...
python3 spin/generate_vllm.py --model UCLA-AGI/zephyr-7b-sft-full-SPIN-iter0 --input_dir UCLA-AGI/SPIN_iter0 --frac_len 800 --data_frac 0 --world_size 8 --output_dir generated/iter1 --split test