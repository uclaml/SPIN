...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=8 --main_process_port 2950 spin/run_spin.py configs/config_iter2.yaml --learning_rate=1.0e-7 --beta=0.1 --warmup_ratio=0.1 --num_train_epochs=6 --output_dir="outputs/iter2-ckpt"
